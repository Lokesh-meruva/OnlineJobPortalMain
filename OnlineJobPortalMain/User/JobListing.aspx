<%@ Page Title="" Language="C#" MasterPageFile="~/User/UserMaster.Master" AutoEventWireup="true" CodeBehind="JobListing.aspx.cs" Inherits="OnlineJobPortalMain.User.JobListing" %>
                        ...
                        <div class="job-category-listing mb-50 pb-0">
                            ...
                            <div class="single-listing">
                                ...
                                <div class="select-job-items2">
                                    ...
                                    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:JobPortalConnectionString2 %>"

                                        SelectCommand="SELECT [CountryName] FROM [Country]" ProviderName="<%$ ConnectionStrings:JobPortalConnectionString2.ProviderName %>"></asp:SqlDataSource>
                                        ...
                                        <div class="single-job-items mb-30">
                                            ...
                                            <div class="items-link items-link2 f-right">
                                                ...
                                                <span class="text-secondary">
                                                    ...
                                                    <%# RelativeDate(Convert.IsDBNull(Eval("CreateDate")) ? DateTime.MinValue : Convert.ToDateTime(Eval("CreateDate"))) %>
